...
{\small
\begin{tabular}{p{3.6cm}p{2.4cm}p{2.2cm}p{2.6cm}}
\toprule
...
\vspace{8pt}
{\small
\begin{tabular}{p{4.3cm}p{2.6cm}p{4.3cm}}
\toprule
...
% ─────────────────────────────────────────────────────────────────────────────
\begin{frame}{Does OAI Calm the Trend More Than VAI? (John's Hypothesis)}
John's expectation: after an inspection, the AE rise should reverse with a lag,
...
\vspace{8pt}
{\small
\begin{tabular}{p{3.0cm}p{1.8cm}p{3.6cm}p{2.6cm}}
\toprule
...
{\small
\begin{tabular}{p{2.2cm}p{2.4cm}p{2.4cm}p{4.0cm}}
\toprule
Model & Baseline AUC & With-text AUC & Note \\
\midrule
Recall (m14) & 0.26--0.34 & too few events & baseline below random \\
AE (m17) & 0.57--0.60 & 0.43--0.49 & baseline up, with-text down \\
