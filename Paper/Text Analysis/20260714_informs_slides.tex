...
\begin{itemize}
  ...
  \item \textbf{Same inspection, two different domains} -- Data Integrity vs.\ Lab Controls, each carrying different risk implications
  \item Domain, severity, and patient risk are embedded in the prose; there are no structured fields or shared schema -- extracting them requires reading the text
\end{itemize}
}
\end{frame}
