...
\begin{itemize}
  ...
  \item When GMP violations are found, inspectors issue a \textbf{Form 483} -- a written list of deficiencies, handed to the facility at the close of inspection
  \item FDA monitors quality between visits through recalls, FAERS adverse events, and drug complaints -- but the detailed text of 483 observations has not been used in research to predict future failures
\end{itemize}
...
\begin{tikzpicture}[x=0.80cm, y=0.85cm]
  ...
  \node[font=\scriptsize, ncsuRed, align=center] at (1.5,0.55) {$\approx$1--3 yr gap\\483 text unused};
  \node[font=\scriptsize, ncsuRed, align=center] at (3.5,0.55) {$\approx$1--3 yr gap\\483 text unused};
