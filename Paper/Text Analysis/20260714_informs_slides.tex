...
\begin{itemize}
  ...
  \item Observations share a standard CFR citation header, but the body is inspector-written and facility-specific. Pairwise Jaccard similarity across 1,067 observations averages 0.10 -- nearly all vocabulary is unique to each observation.
\end{itemize}
}
\end{frame}
