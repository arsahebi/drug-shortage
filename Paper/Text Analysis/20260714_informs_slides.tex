...
\begin{itemize}
  ...
  \item \textbf{FAERS attribution:} many AE reports do not name a specific manufacturer, so we cannot link them to a facility. For manufacturers with multiple production sites, attribution is approximate even when a name is present.
\end{itemize}
