...
\begin{itemize}
  ...
  \item \textbf{Replace FAERS with MarketScan:} MarketScan links prescriptions to NDC-level dispensing records and patient outcomes -- a cleaner tie between facility and harm than FAERS.
