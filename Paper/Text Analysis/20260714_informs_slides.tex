...
\begin{itemize}
  ...
  \item 129 facilities (FEIs) identified by tracing NDC codes through DailyMed labels to ANDA approvals
\end{itemize}
}
...
\begin{itemize}
  ...
  \item All 98 analytic-sample FEIs have ANDA-level AE linkage
\end{itemize}
}

\vspace{5pt}
\onslide<4->{
\textbf{Panel:} one row per inspection, $\pm$4 quarters. \highlight{246 rows} total.
}
