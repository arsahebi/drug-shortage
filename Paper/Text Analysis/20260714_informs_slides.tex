...
\begin{itemize}
  ...
  \item \textbf{Before the visit (Q-2):} severity is already significant -- facilities with more severe findings were generating more AEs before FDA arrived
  \item \textbf{After the visit (Q+2):} Lab Controls joins as a significant signal, and severity strengthens further
  \item Two different features dominate at two different moments -- severity captures what is already happening; Lab Controls predicts what follows
\end{itemize}
