...
\midrule
\texttt{n\_labcontrols\_obs}    & +0.10 &    & \tech{+0.28} & *** \\
\texttt{joint\_labctrl\_di}     & +0.07 &    & \tech{+0.26} & **  \\
\texttt{joint\_contam\_labctrl} & +0.05 &    & \tech{+0.23} & **  \\
\texttt{vc\_labcontrols\_share} & +0.07 &    & \tech{+0.20} & *   \\
\texttt{severity\_critmajor}    & +0.23 & ** & +0.20        & *   \\
\midrule
\texttt{data\_integrity\_flag}  & +0.14 &    & +0.06        &     \\
