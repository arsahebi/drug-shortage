...
\begin{figure}[h!]
\centering
\includegraphics[width=0.7\textwidth]{../../Data/99 - Outputs - Shortage Prediction/outputs/figures/feature_importance_valisure.png}
\caption{Random Forest feature importance (sorted). Teal = LLM-derived
         text indices. QCI = Quality Culture Index (3rd overall, 14.8\%).
         Combined text importance $\approx$ 32\%.}
\label{fig:fi}
\end{figure}
